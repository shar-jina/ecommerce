            ...
            <section className="pt-8 pb-16 px-6 md:px-12 bg-white">
                <div className="container mx-auto">
                    {heroPosts.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-2 gap-6 h-auto lg:h-[650px] mb-12">
                            <div className="lg:col-span-8 lg:row-span-1 relative overflow-hidden rounded-3xl group bg-[#F2F7F7]">
                                <div className="absolute inset-0 flex flex-col md:flex-row items-center">
                                    <div className="w-full md:w-1/2 p-10 md:p-14 z-10">
                                        ...
                                        <h3 className="text-4xl md:text-5xl font-black font-heading uppercase mb-6 leading-tight text-onyx">System Integration.</h3>
                                    ...
                                    <div className="w-full md:w-1/2 h-full">
                                        <img src="https://images.unsplash.com/photo-1550009158-9ebf69173e03?q=80&w=2101&auto=format&fit=crop" className="w-full h-full object-contain p-4 transition-transform duration-700 group-hover:scale-110" />
                                    </div>
                                </div>
                            </div>

                            <div className="lg:col-span-4 lg:row-span-2 relative overflow-hidden rounded-3xl group bg-[#F9F3F1]">
                                <div className="p-10 z-10 relative text-center lg:text-left">
                            ...
                            <div className="lg:col-span-8 lg:row-span-1 relative overflow-hidden rounded-3xl group bg-[#EEF2F6]">
                                <div className="absolute inset-0 flex flex-row items-center">
                                    <div className="w-1/2 md:w-1/3 p-8 z-10">
                                    ...
                                    <div className="w-1/2 md:w-2/3 h-full">
                                        <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-contain p-2 transition-transform duration-700 group-hover:scale-110 opacity-60" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center mb-12">
                            <div className="w-full max-w-5xl h-[400px] lg:h-[450px] relative overflow-hidden rounded-retail group shadow-2xl">
                                <img src={heroPosts[0].image} alt={heroPosts[0].title} className="w-full h-full object-cover transition-transform duration-[3s] group-hover:scale-105" />
                                <div className="absolute inset-0 bg-gradient-to-t from-teal/90 via-teal/20 to-transparent flex flex-col justify-end p-8 md:p-16 text-white">
                                    <span className="text-orange text-[10px] font-black uppercase tracking-[0.5em] mb-4">Featured Highlight</span>
                                    <h2 className="text-4xl md:text-5xl font-black font-heading tracking-tight leading-none mb-6 uppercase">{heroPosts[0].title}</h2>
                                    <p className="text-white/70 text-base max-w-xl mb-8 font-light leading-relaxed line-clamp-2">{heroPosts[0].description}</p>
                                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            {heroPosts.map((post, i) => (
                                <div key={post.id} className="relative h-[350px] overflow-hidden rounded-retail group shadow-xl">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-teal/40 to-teal/90 flex flex-col justify-end p-10 text-white">
                                        ...
                                        <h3 className="text-3xl font-black font-heading uppercase mb-4 leading-tight">{post.title}</h3>
                        ...
                        /* Case 3: Premium Mosaic Grid (3+ posts) - Exactly like reference */
                        <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-2 gap-6 h-auto lg:h-[700px] mb-12">
                            {/* Main Featured - Top Left (Large Horizontal) */}
                            {heroPosts[0] && (
                                <div className="lg:col-span-8 lg:row-span-1 relative overflow-hidden rounded-3xl group bg-[#F2F7F7]">
                                    <div className="absolute inset-0 flex flex-col md:flex-row items-center">
                                        <div className="w-full md:w-1/2 p-10 md:p-14 z-10">
                                            ...
                                            <h3 className="text-4xl md:text-5xl font-black font-heading uppercase mb-6 leading-tight text-onyx">{heroPosts[0].title}</h3>
                                            <p className="text-gray-500 text-sm mb-8 max-w-xs leading-relaxed">{heroPosts[0].description?.substring(0, 80)}...</p>
                                        ...
                                        <div className="w-full md:w-1/2 h-full">
                                            <img src={heroPosts[0].image} alt={heroPosts[0].title} className="w-full h-full object-contain p-4 transition-transform duration-700 group-hover:scale-110" />
                                        </div>
                                    </div>
                                </div>
                            )}

                            {/* Tall Feature - Right Side (Full Height) */}
                            {heroPosts[1] && (
                                <div className="lg:col-span-4 lg:row-span-2 relative overflow-hidden rounded-3xl group bg-[#F9F3F1]">
                                    <div className="p-10 z-10 relative">
                                        ...
                                        <h3 className="text-3xl font-black font-heading uppercase mb-4 text-teal leading-tight">{heroPosts[1].title}</h3>
                            ...
                            {/* Bottom Area - Dynamic spans */}
                            {heroPosts[2] && (
                                <div className={`${heroPosts.length === 3 ? 'lg:col-span-8' : 'lg:col-span-4'} lg:row-span-1 relative overflow-hidden rounded-3xl group bg-[#EEF2F6]`}>
                                    <div className="absolute inset-0 flex flex-row items-center">
                                        <div className={`${heroPosts.length === 3 ? 'w-1/2 md:w-1/3' : 'w-1/2'} p-8 z-10`}>
                                            <span className="text-teal/40 text-[9px] font-black uppercase tracking-[0.2em] mb-2 block">Offers</span>
                                            <h3 className="text-xl font-black font-heading uppercase mb-4 text-teal leading-tight">{heroPosts[2].title}</h3>
                                        ...
                                        <div className={`${heroPosts.length === 3 ? 'w-1/2 md:w-2/3' : 'w-1/2'} h-full`}>
                                            <img src={heroPosts[2].image} alt={heroPosts[2].title} className="w-full h-full object-contain p-2 transition-transform duration-700 group-hover:scale-110" />
                                        </div>
                                    </div>
                                </div>
                            )}

                            {/* Fourth Post (Only shown if available) */}
                            {heroPosts.length >= 4 && (
                                    <div 
                                        onClick={() => navigate('/productdetail', { state: { category: heroPosts[3].target_category || heroPosts[3].product_id } })}
                                        className="lg:col-span-4 lg:row-span-1 relative overflow-hidden rounded-3xl group bg-[#FEF6F5] cursor-pointer"
                                    >
                                    <div className="absolute inset-0 flex flex-row items-center">
                                        <div className="w-full h-full relative">
                                            <img src={heroPosts[3].image} alt={heroPosts[3].title} className="w-full h-full object-contain p-4" />
            ...
            <section className="py-16 bg-white border-b border-gray-100">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col items-center mb-12">
                        ...
                        <h2 className="text-3xl font-black font-heading tracking-tight uppercase text-teal">By Architecture</h2>
                    </div>
                ...
                <div className="container mx-auto px-6 md:px-12">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                        <div>
                            ...
                            <h2 className="text-4xl font-black font-heading tracking-tight uppercase text-teal text-center md:text-left">Featured Innovations</h2>
                        </div>
                ...
                <div className="container mx-auto px-6 md:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                        <div className="md:col-span-1">
                            <h1 className="text-2xl font-black tracking-tight text-teal font-heading mb-6">
                                BIT<span className="text-orange">FIX.</span>
                            </h1>
