            ...
            <nav className="bg-white border-b border-gray-100 px-6 md:px-12 py-4 shadow-sm">
                <div className="container mx-auto flex items-center justify-between gap-8">
                    ...
                    <div className="flex items-center gap-4 md:gap-8">
                        ...
                        {/* Wishlist */}
                        <Link to="/wishlist" className="hidden md:flex flex-col items-center gap-1 text-gray-400 hover:text-teal transition-colors">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Cart */}
                        <Link to="/cart" className="hidden md:flex flex-col items-center gap-1 text-gray-400 hover:text-teal transition-colors relative">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Account */}
                        {isLoggedIn ? (
                            <button onClick={handleLogout} className="hidden md:flex flex-col items-center gap-1 text-gray-400 hover:text-teal transition-colors group">
                            ...
                            <Link to="/login" className="hidden md:flex flex-col items-center gap-1 text-gray-400 hover:text-teal transition-colors group">
